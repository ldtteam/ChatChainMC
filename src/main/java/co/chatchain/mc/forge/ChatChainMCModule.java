...
import co.chatchain.commons.infrastructure.replacements.ClientReplacements;
import co.chatchain.commons.infrastructure.replacements.GenericMessageReplacements;
import co.chatchain.commons.infrastructure.replacements.GroupReplacements;
...
public class ChatChainMCModule extends AbstractModule
{
    ...
    private static class Logger implements ILogger
    {
        ...
        {
            ChatChainMC.instance.getLogger().error(error, exception);
        }
    }
}
