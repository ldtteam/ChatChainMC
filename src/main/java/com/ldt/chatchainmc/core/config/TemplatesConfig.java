...
public class TemplatesConfig extends BaseConfig
{
    ...
    @Setting(value = "local-channel-template-overrides", comment = "Override for specific channel placeholders in here.")
    public Map<String, String> localChannelOverrideMessages = new HashMap<>();
