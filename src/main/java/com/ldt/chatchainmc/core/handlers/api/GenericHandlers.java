package com.ldt.chatchainmc.core.handlers.api;
...
import com.ldt.chatchainmc.core.util.TemplateMessages;
                  ...
                  && clientConfig.channels.containsKey(channelName))
            {
                for (final String channel : clientConfig.channels.get(channelName))
                {
                    ...
                    for (final EntityPlayer player : ChatChainMC.instance.getServer().getPlayerList().getPlayers())
                    {
                        ...
                        if (channelStorage != null && channelStorage.getListeningChannels().contains(channel))
                        {
